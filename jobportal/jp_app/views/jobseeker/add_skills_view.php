   ...
   <div class="col-md-3"> <div class="dashiconwrp">
    ...
    <div class="col-md-9"> <?php echo $this->session->flashdata('msg');?>
      ...
      <div class="formwraper">
        ...
        <div class="formint">
          <p class="normal-details" style="font-size:13px;">Please enter your skills keywords below. Please know that your resume will be searched based on these skills. If you do not enter all skills, your resume will not be included in our search for your desired jobs.<br>
            <br />
          ...
          <br>
          Accountant may enter following:   Accountant, cost accountant, ACCA, Chartered Accountant </p>
          ...
          <div class="input-group">
            ...
            <small>Single skill at a time. Atleat 3 skills are required. </small>
